...
public class Jogo6 extends Panel {
    ...
    static Frame frame = new Frame("Fase 6");
    ...
    public void montarFrame() {
        frame = this.util.montarFrameGenerico(6);
        frame.setTitle("Jogo 6");
    }
    ...
    private void ajustarTamanhoRetangulo() {
        ...
        this.alturaRetanguloPadrao = util.getAlturaTela() / 7;
        this.larguraRetanguloPadrao = util.getAlturaTela() / 7;

        fracaoLargura = util.getLarguraTela() / 5;
        fracaoLarguraRetangulo = fracaoLargura / 5;
